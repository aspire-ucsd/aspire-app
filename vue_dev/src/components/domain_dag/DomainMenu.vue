...
function menuClick(event) {
    switch(true) {
        case event === 'addConcept' && !props.selectedModule:
            break;
        case event === 'deleteConcepts' && !props.selectedConcepts.length > 0:
            break;
        case event === 'joinConcepts' && !props.selectedConcepts.length > 1:
            break;
        case event === 'moduleConceptAdd' && !props.selectedConcepts.length > 0 && !props.selectedModule:
            break;
        case event === 'junctionDelete' && !props.selectedEdges.length > 0:
            break;
        case event === 'moduleConceptDelete' && !props.selectedConcepts.length > 0 && !props.selectedModule:
            break;
        case event === 'boxSelect':
            menuEmit("boxSelect")
            break;
        default:
...
#add-concept {
    fill: v-bind('props.selectedModule ? "#0f8800" : "#4c4c4c"');
    ...
    <svg 
        ...
        <g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" style="display:inline">
            <g 
                ...
                >
                <title>{{props.selectedConcepts.length > 0 ? "Delete Selected Concepts" : "Delete Selected Concepts\nWARNING: Must select at least one Concept"}}</title>
            ...
            <g 
                ...
                >
                <title>{{props.selectedModule ? "Add Concept" : "Add Concept\nWARNING: Must Select a Module"}}</title>
                <path id="add-concept" onclick="" inkscape:label="addConceptBtn"
                    style="fill-opacity:1;stroke:#000000;stroke-width:0.203378;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:0;filter:url(#filter1099)"
            ...
            <g 
                ...
                >
                <title>{{props.selectedConcepts.length > 1 ? "Join Selected Concepts" : "Join Selected Concepts\nWARNING: Must select at least two Concepts"}}</title>
            ...
            <g 
                ...
                >
                <title>{{props.selectedConcepts.length > 0 && props.selectedModule ? "Add Selected Concepts To Module" : "Add Selected Concepts To Module\nWARNING: Must select at least one Concept and a Module"}}</title>
                <path id="module-add"
            ...
            <g 
                ...
                >
                <title>{{props.selectedEdges.length > 0 ? "Delete Selected Junctions" : "Delete Selected Junctions\nWARNING: Must select at least one Junction"}}</title>
            ...
            <g 
                ...
                >
                <title>{{props.selectedConcepts.length > 0 && props.selectedModule ? "Remove Concepts From Module" : "Remove Concepts From Module\nWARNING: Must select at least one Concept and a Module"}}</title>
